...
![Дашборд](docs/images/dashboard_screenshot.png)
...
![Настройки камер](docs/images/settings_screenshot.png)
...
![Настройка геозон](docs/images/camera_zone_screenshot.png)
...
![Аналитика](docs/images/analytics_screenshot.png)
...
│
├── docs/                         # Папка с руководством пользователя (документация)
│   ├── images/
│   └── README.md               
│
